...
export default class MemberCard extends Component {
  ...
  render() {
    ...
    return (
      <Row
        style={{
          backgroundColor: this.props.id % 2 === 0 ? hoveredBlue : hoveredGray
        }}
              ...
              <Col>
                <Row>
                  {this.props.member.project[0] && (
                    <p className="pb0 mb0 mt2 white">
                      Project: <strong>{this.props.member.project[0]}</strong>
                    </p>
                  )}
                </Row>
                <Row>
                  <p className="white mt2">
                    Terms On:{" "}
                    <strong>{this.props.member.terms_on.join(", ")}</strong>
                  </p>
                </Row>
              </Col>
            </Row>
